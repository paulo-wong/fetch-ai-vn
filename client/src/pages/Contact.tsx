...
const WHATSAPP_NUMBER = "6586069949";
            ...
            <div className="lg:col-span-2">
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-6 animate-on-scroll">
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    <div><label className="block text-xs font-bold uppercase tracking-widest text-gray-400 mb-1.5 font-body">Phone (Optional)</label><input type="tel" value={form.phone} onChange={(e) => setForm({...form, phone: e.target.value})} className="w-full px-4 py-3 rounded-sm border border-[#E8EDF5] text-sm font-body focus:outline-none focus:border-[#17264E]" placeholder="+65 XXXX XXXX" /></div>
              ...
              <div className="p-6 rounded-xl border border-[#E8EDF5]">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <a href={`https://wa.me/${WHATSAPP_NUMBER}`} target="_blank" rel="noopener noreferrer" className="text-gray-600 text-sm font-body hover:text-[#17264E]">+65 8606 9949 (WhatsApp)</a>
                  </div>
                  <div className="flex items-center gap-3"><MapPin className="w-4 h-4 text-[#FFBE16] flex-shrink-0" /><span className="text-gray-600 text-sm font-body">Singapore</span></div>
                  <div className="flex items-center gap-3"><Clock className="w-4 h-4 text-[#FFBE16] flex-shrink-0" /><span className="text-gray-600 text-sm font-body">Mon–Fri, 9am–6pm SGT</span></div>
                </div>
              </div>
            </div>
          </div>
